...
void BloomNeon::bloomEffect(sf::Vector2f neonPosition, sf::Vector2f neonScale, float neonColor1, float neonColor2, float neonColor3, float alphaColor)
{
	...
	{
		color_vtx[i + 1] = sf::Color(neonColor1, neonColor2, neonColor3, alphaColor);
