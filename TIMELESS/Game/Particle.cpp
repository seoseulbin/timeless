...
ParticleEmitter::ParticleEmitter(std::string spriteFile, int totalParticles, double lifetime, bool displayUnder) : numParticles(totalParticles), lifetime(lifetime)
{
...
ParticleEmitter::Particle::Particle(std::string spriteFile, bool displayUnder) : GameObject{{0, 0}}, life(0), max_life(0), is_display_under(displayUnder)
{
