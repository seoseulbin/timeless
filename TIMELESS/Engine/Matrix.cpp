...
{
	matrix[0][0] = 1;	matrix[0][1] = 0;	matrix[0][2] = (float)translate.x;
	matrix[1][0] = 0;	matrix[1][1] = 1;	matrix[1][2] = (float)translate.y;
...
{
	matrix[0][0] = 1;	matrix[0][1] = 0;	matrix[0][2] = static_cast<float>(translate.x);
	matrix[1][0] = 0;	matrix[1][1] = 1;	matrix[1][2] = static_cast<float>(translate.y);
	matrix[2][0] = 0;	matrix[2][1] = 0;	matrix[2][2] = 1;
}
