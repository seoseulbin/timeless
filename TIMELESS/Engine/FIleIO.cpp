...
void FileInput::Read(string path)
{
    ...
    if (!source) {                    
        ...
        int stage_level;
        int total_stage;
        if (filetype == "Pattern") {    //if file data is about pattern
            ...
            for (std::string line; std::getline(source, line); )  
            {
                ...
                pattern_data[stage_level - 1].push_back(p_new);
          ...
          //  pattern_data.push_back(temp_pattern);
        ...
        else if (filetype == "Map") {   //if file data is about Map design
            input >> stage_level;
        ...
        else if (filetype == "Savefile") { //if file data is about savefile


        }
        else if (filetype == "Gamedata") { //if file data is about Gamedata
            ...
            pattern_data.resize(total_stage);
            map_data.resize(total_stage);
        }
